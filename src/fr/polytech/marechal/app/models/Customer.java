...
import fr.polytech.marechal.app.models.managers.CustomersManager;
import fr.polytech.marechal.app.models.managers.StaffsManager;
...
public class Customer extends Model<Customer>
{
    ...
    public boolean saveAll () throws IOException
    {
        ...
        for (Order order : orders)
        {
            ...
            success &= order.saveAll();
        }

        if(staff != null)
        {
            success &= staff.saveAll();
        }
